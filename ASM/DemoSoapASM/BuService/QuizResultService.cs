...
namespace BuService
{
    ...
    public class QuizResultService : IQuizResultService
    {
        ...
        {
            // Get all results and sort them by a property (e.g., Score) in descending order, then take top 10
            var allResults = await _quizResultRepository.GetAllAsync2();
            return allResults
                .OrderByDescending(r => r.Score) // Replace 'Score' with your sorting property
                .Take(10)
                .ToList();
        }
