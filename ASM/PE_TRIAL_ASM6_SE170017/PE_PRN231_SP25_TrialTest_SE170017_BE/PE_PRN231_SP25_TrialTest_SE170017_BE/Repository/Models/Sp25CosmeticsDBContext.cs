...
public partial class Sp25CosmeticsDBContext : DbContext
{
    ...
    public Sp25CosmeticsDBContext(DbContextOptions<Sp25CosmeticsDBContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Cosmetic__19093A2B8043A31A");
        ...
        {
            entity.HasKey(e => e.CosmeticId).HasName("PK__Cosmetic__98ED527E53043613");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.CosmeticInformations)
                ...
                .HasConstraintName("FK__CosmeticI__Categ__4E88ABD4");
        });

        modelBuilder.Entity<SystemAccount>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586D349ADDD");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__SystemAc__49A14740DC3B99BE").IsUnique();
